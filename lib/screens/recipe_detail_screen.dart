...
class _RecipeDetailScreenState extends State<RecipeDetailScreen> {
  ...
  Widget build(BuildContext context) {
    if (kIsWeb && _updatedRecipe != null) {
      // update HTML title
      html.document.title = '${_updatedRecipe!.name} on Escoffee App';
    }
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text(
                            'Temperatura de agua: ${_updatedRecipe!.waterTemp ?? "Not provided"}ºC / ${(_updatedRecipe!.waterTemp != null ? (_updatedRecipe!.waterTemp! * 9 / 5 + 32).toStringAsFixed(1) : "Not provided")}ºF'),
                        const SizedBox(height: 16),
                        Text(
                            'Tamaño de molienda: ${_updatedRecipe!.grindSize}'),
                        const SizedBox(height: 16),
                        Text(
                            'Tiempo de preparación: ${_updatedRecipe!.brewTime.toString().split('.').first.padLeft(8, "0")}'),
                        const SizedBox(height: 16),
                        ExpansionTile(
                          title: const Text('Resumen de la receta'),
                          subtitle: const Text(
                              'Nota: esta es una receta básica con cantidades predeterminadas de café y agua.'),
      ...
      return RichText(
        text: TextSpan(
          children: [
            ...
            TextSpan(
              text: linkText,
              style: defaultTextStyle.copyWith(color:const Color(0xFFD75A72)),

...
class _DonationScreenState extends State<DonationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Apoyar el desarrollo'),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              '¡Gracias por considerar donar!',
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 16),
            const Text(
              'Tus donaciones ayudan a cubrir los costes de mantenimiento (como las licencias de desarrollador, por ejemplo). También me permiten probar más dispositivos para preparar café y agregar más recetas a la aplicación.',
            ),
